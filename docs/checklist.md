...
1. **댓글 시스템 구현** (Giscus 연동) - Day 14
2. **Contact 페이지 완성** (EmailJS 연동 또는 연락처 정보) - Day 15
3. **About 페이지 독립 구현** (홈 섹션을 확장하여 독립 페이지로)
4. **성능 최적화 완성** (코드 스플리팅, 번들 최적화)
5. **SEO 최적화 완성** (구조화된 데이터, Lighthouse 테스트)
6. **테스트 및 배포**
